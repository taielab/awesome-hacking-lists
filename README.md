...
- [Kernelhub](https://github.com/Ascotbe/Kernelhub) - windows 提权漏洞利用合集，利用脚本都已经生成可执行文件，附带编译环境，演示GIF图，漏洞详细信息
...
- [asm_cleaner](https://github.com/hasherezade/asm_cleaner) - A helper utility for creating shellcodes. Cleans MASM file generated by MSVC, gives refactoring hints.
...
- [nemo](https://github.com/hanc00l/nemo) - 
...
- [seata-golang](https://github.com/transaction-wg/seata-golang) - go 微服务的分布式事务解决方案，java 版 seata 的翻版。钉钉群：seata-golang
...
- [mos-chinadns](https://github.com/IrineSistiana/mos-chinadns) - 一个DNS分流小软件。准确、快速、简单、解压即用。
...
- [slack-c2bot](https://github.com/praetorian-code/slack-c2bot) - Slack C2bot that executes commands and returns the output.
...
- [baidu-netdisk-downloaderx](https://github.com/88250/baidu-netdisk-downloaderx) - ⚡️ 一款图形界面的百度网盘不限速下载器，支持 Windows、Linux 和 Mac。已于 2020 年 4 月 15 日正式停用，源码仅用于程序员交流学习，细节请查看：关于停用 BND 的说明 https://hacpai.com/article/1586956316578
...
- [CobaltStrike_Script_Wechat_Push](https://github.com/a1ices/CobaltStrike_Script_Wechat_Push) - CobatStrike-Script, Beacon上线,微信实时推送!
- [BurpCollector](https://github.com/a1ices/BurpCollector) - 通过BurpSuite来构建自己的爆破字典，可以通过字典爆破来发现隐藏资产。
...
- [awesome-opensource-security](https://github.com/CaledoniaProject/awesome-opensource-security) - A list of interesting stuffs that I have no time to test/review
...
- [GatherInfo](https://github.com/Paper-Pen/GatherInfo) - 渗透测试信息搜集/内网渗透信息搜集
...
- [twitter](https://github.com/atymic/twitter) - Twitter API for Laravel 5.5+, 6.x & 7.x
...
- [shondanquery](https://github.com/t0gu/shondanquery) - Small tool that i wrote to automate my searchs at shodan api. I use this to query api shodan fast, search for favicon or strings title. I know that shodan have a cli but i wrote this one just for generic searches. :p
...
- [WebHunt](https://github.com/WebHunt-Kits/WebHunt) - A command line tool for analyzing web components for security testing. 𒈯
...
- [Medusa](https://github.com/Ascotbe/Medusa) - :cat2:MedusaIt is an integrated platform with functions such as vulnerability scanning, vulnerability exploitation, subdomain detection, C segment scanning, asset discovery, and sensitive information detection. Currently contains 200+ vulnerabilities http://medusa.ascotbe.com
...
- [vpstoolbox](https://github.com/johnrosen1/vpstoolbox) - VPSToolBox is a bash script that helps you setup Trojan-gfw Nginx Hexo Netdata and other powerful applications on a Linux server really quickly.
